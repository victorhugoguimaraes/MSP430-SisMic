...
laco2:
        ...
        jhs     nao_troca                 ; se Frente >= Atual (sem sinal), ta certo. pula a troca.

        ; Se chegou aq eh pq o Atual > Frente. Entao troca eles de lugar
...
nao_troca:
        ...
        dec.w   R4                        ; diminui o laco 1 (o maior ja "subiu" pro fim)
        jnz     laco1                     ; se ainda faltam varridas, volta pro laco 1
